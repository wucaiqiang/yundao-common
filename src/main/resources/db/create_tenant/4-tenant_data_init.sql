...
DECLARE _smsIsDefault BIGINT;



/*租户id*/
select tenant_id INTO _tenantId from tenant_temp_table LIMIT 1;

select sms_access_key_id INTO _smsAccessKeyId from tenant_temp_table LIMIT 1;
select sms_access_key_secret INTO _smsAccesskeySecret from tenant_temp_table LIMIT 1;
select sms_sign INTO _smsSign from tenant_temp_table LIMIT 1;
select sms_is_default INTO _smsIsDefault from tenant_temp_table LIMIT 1;
...
if(_smsIsDefault = 1) then
	INSERT INTO `sms_conf` (`tenant_id`, `use_defalut_channel`, `is_filter_dimission`, `create_date`, `create_user_id`, `is_delete`) VALUES 
	(_tenantId, 1, 1, '2017-10-25 17:37:17', NULL, 0);
else  
    INSERT INTO sms_account (tenant_id, access_key_id, access_key_secret, sign, is_enable, create_date, create_user_id, update_user_id, update_date, is_delete) 
    VALUES (_tenantId, _smsAccessKeyId, _smsAccesskeySecret, _smsSign, 1, null, null, null, null, 0);
end if;
...
INSERT INTO sms_template (tenant_id, code, third_party_code, name, message, description, is_enable, create_user_id, create_date, update_user_id, update_date, is_delete) VALUES (_tenantId, 'captcha_2c_retrieve_pwd', 'SMS_99890016', '找回密码', null, null, 1, null, null, null, null, 0);
INSERT INTO sms_template (tenant_id, code, third_party_code, name, message, description, is_enable, create_user_id, create_date, update_user_id, update_date, is_delete) VALUES (_tenantId, 'captcha_2c_register', 'SMS_100015016', '注册', null, null, 1, null, null, null, null, 0);
