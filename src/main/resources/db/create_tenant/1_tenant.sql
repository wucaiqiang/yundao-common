...
SELECT tenant_id INTO _tenantId FROM user_account LIMIT 1;
   ...
   UPDATE number_config SET decimal_length=0 WHERE  object_field_id IN(6,7);
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='模板类型表';
...
INSERT INTO `msg_template_type` VALUES ('6', '1', '有待上线审核的产品', '2', '1', '4', null, null, null, null, '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='模板类型关联关系表';
...
/* 额度预约被驳回 - 消息动态 结束 */
	...
	/* 销售线索对应角色 初始化数据 */
UPDATE data_object_access SET read_permission=10, edit_permission=10,delete_permission=0  WHERE data_object_id=12 AND role_id=1;
