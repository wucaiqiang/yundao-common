...
DECLARE _userRealName VARCHAR(20);
DECLARE _userAccountId BIGINT;
DECLARE _roleId BIGINT;

SET _smsAccessKeyId='';
SET _smsAccesskeySecret='';
SET _smsSign='';
...
/*管理员在SCM 对应的id*/
SET _userAccountId = 33;
/*管理员手机号*/
SET _userMobile = '17900000002';
/*管理员角色id*/
SET _roleId = 1;
/*管理员姓名*/
SET _userRealName='系统管理员';
...
VALUES (_userAccountId, _tenantId, NULL, _userMobile, NULL, NULL, 0, 1,1, NULL, NULL, NULL, NULL, 0);
...
VALUES ( _tenantId, _userAccountId, 0, 1, NULL, NULL, NULL, NULL, 0);
...
VALUES (_tenantId, _userAccountId, NULL, _userRealName, NULL, 0, NULL, null, NULL, NULL, NULL, 0);
...
VALUES (_tenantId, _userAccountId, _roleId, 1, NULL, NULL, NULL, NULL, 0);
...
VALUES (_tenantId, _userAccountId, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
INSERT INTO sms_conf (`tenant_id`, `use_defalut_channel`, `is_filter_dimission`, `create_date`, `create_user_id`, `update_user_id`, `update_date`, `is_delete`) VALUES (_tenantId, 1, 1, NULL, NULL, NULL, NULL, 0);
