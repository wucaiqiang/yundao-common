package com.yundao.common.aspect;
...
public class LoggerPrintManager {
	...
	@Pointcut("(execution(* com.yundao.common.controller..*.*(..))) && (!execution(* com.yundao.common.aspect..*.*(..)))")  
    ...
    public Object pringLog(ProceedingJoinPoint pjp) throws Throwable { 
    	 if(pjp == null ){
    		 logger.info("com.yundao.common.aspect.LoggerPrintManager [pringLog] param is null");
    		 return null;
    	 }
		 ...
		 if(retObject !=null && retObject instanceof Result){
			 try {
				...
				logger.error("com.yundao.common.aspect.LoggerPrintManager [pringLog] is error,cause is ",e);
			}
		 }
