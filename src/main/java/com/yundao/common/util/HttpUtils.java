...
public class HttpUtils {
	 ...
	 * @description:
	 */
	public static void callTenantUrl(Long tenandId, String invokeUrl, String method, Map<String, String> methodParams)
			throws Exception {
		...
		headerParams.putAll(getHeaderParams(tenandId));
		requestParams.setHeaderParams(headerParams);
		if (CommonConstant.POSTMETHOD.equalsIgnoreCase(method)) {
			com.yundao.core.utils.HttpUtils.post(invokeUrl, requestParams);
		}
		else {
			com.yundao.core.utils.HttpUtils.get(invokeUrl, requestParams);
		}
	}
	 ...
	 * @return 头部参数
	 */
	private static Map<String, String> getHeaderParams(Long tenandId) {
